...
def epopform(r):
    ...
    if r.method == "POST":
        ...
        return HttpResponseRedirect(
            "/epop/show/"
        )  # This is route for redirect here 'epop':- project level url and 'show':- app level urls
    return render(
        r, "epop/registration.html", {"form": form}
    )  # template folder--> epop/registration.html
